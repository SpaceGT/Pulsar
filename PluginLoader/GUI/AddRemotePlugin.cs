...
{
    internal class AddRemotePlugin : PluginScreen
    {
        private Action<RemotePluginConfig> AddSource;
        ...
        public AddRemotePlugin(Action<RemotePluginConfig> onAdd)
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            MyGuiControlLabel fileLabel = new MyGuiControlLabel(
                position: new Vector2(
                    0,
        ...
        {
            RemotePluginConfig source = new RemotePluginConfig()
            {
                Name = RepoInput.Text,
