...
{
    internal class SourcesWarning : PluginScreen
    {
        private Action<bool> CloseFunc;

        private SourcesConfig Config;
        ...
        public SourcesWarning(SourcesConfig config, Action<bool> onClose)
            : base(size: new Vector2(0.5f, 0.4f))
        {
            Config = config;
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            MyGuiControlMultilineText text = new MyGuiControlMultilineText()
            {
                Text = Text,
