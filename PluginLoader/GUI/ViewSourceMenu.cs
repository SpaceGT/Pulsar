...
{
    internal class ViewSourceMenu : PluginScreen
    {
        private object Source;
        private Action<object> OnRemove;
        private MyGuiControlButton CloseButton;
        private MyGuiControlButton RemoveButton;

        public ViewSourceMenu(object source, Action<object> onRemove)
            : base(size: new Vector2(0.75f, 0.5f))
        {
            Source = source;
            OnRemove = onRemove;
        }
        ...
        )
        {
            ...
            list.SetCustomColumnWidths(new[] { 0.2f, 0.8f });
